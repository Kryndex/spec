...
(assert_return_nan (invoke "f32.no_fold_div_self" (f32.const infinity)))
(assert_return_canonical_nan (invoke "f32.no_fold_div_self" (f32.const nan)))
(assert_return_nan (invoke "f32.no_fold_div_self" (f32.const 0.0)))
(assert_return_nan (invoke "f32.no_fold_div_self" (f32.const -0.0)))
(assert_return_nan (invoke "f64.no_fold_div_self" (f64.const infinity)))
(assert_return_canonical_nan (invoke "f64.no_fold_div_self" (f64.const nan)))
(assert_return_nan (invoke "f64.no_fold_div_self" (f64.const 0.0)))
(assert_return_nan (invoke "f64.no_fold_div_self" (f64.const -0.0)))
